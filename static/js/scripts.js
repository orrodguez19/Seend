...
function openConversation(chat) {
    ...
    if (!chat.isGroup) {
        ...
        DOM.chatUserImage.src = "data:image/svg+xml;base64,";
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    socket.on('new_message', (msg) => {
        ...
        const isCurrentChat = (currentChat.isGroup && msg.receiver_id === currentChat.id) || (!currentChat.isGroup && (msg.sender_id === currentChat.memberId || msg.receiver_id === currentChat.memberId));
        if (isCurrentChat) {
